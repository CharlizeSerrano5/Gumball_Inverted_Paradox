class Fighting extends Phaser.Scene {
    ...
    create() {
        ...
        // testing if each of the characters will go
        for (let i  = 0; i < this.characters.length; i++){
            console.log(this.characters[i].name + this.characters[i].health + this.characters[i].char_attack)
        }
    ...
    update() {
        ...
        // this.characters.health -= this.enemy.attack_dmg
        // console.log(this.enemy.attack_dmg)
        // this.anais_hp.decrease(this.enemy.attack_dmg)
        this.anais_hp.match(this.anais.health)

        // check if the health is working
        if (down.isDown){
            this.anais.health -= 12
            // console.log(this.anais.health)
        }
